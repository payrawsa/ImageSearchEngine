...
montageA = np.zeros((4032 * 5, 3024, 3), dtype = "uint8")
montageB = np.zeros((4032 * 5, 3024, 3), dtype = "uint8")
...
for j in xrange(0, 10):
	...
	if j < 5:
		montageA[j * 4032:(j + 1) * 4032, :] = result

	# otherwise, the second montage should be used
	else:
		montageB[(j - 5) * 4032:((j - 5) + 1) * 4032, :] = result
